...
Github Pages: <https://ashwin2507.github.io/DSCI_521_platforms-dsci_students/>
...
The code chunk option I have used is include=FALSE which prevent the output to be displayed after the code block while other code chunks can still access the value. It does not include the code when you knit the file.
...
print(x * y)
```
Using two chunk options eval and echo eval=FALSE R will not evaluate the code or run it, whereas echo = FALSE prevents the output of code to appear on finish line.
...
HTML: <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_ash2507/blob/master/Test_RMarkdown.html>
PDF: <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_ash2507/blob/master/Test_RMarkdown.pdf>
...
Rmd file: <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_ash2507/blob/master/Test_RMarkdown.Rmd>
Html file: <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_ash2507/blob/master/Test_RMarkdown.html>
...
Github_doc: <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_ash2507/blob/master/Test_RMarkdown.md>
It rendered as the Readme file.
...
Rmd file: <https://github.ubc.ca/MDS-2022-23/DSCI_521_lab4_ash2507/blob/master/New_slides.Rmd>
HTML file: <https://ashwin2507.github.io/DSCI_521_platforms-dsci_students/New_slides.html#1>
...
Power point presentation have a set format of title, section and contents of the slide whereas in R markdown have headers and contents as the only format so it is very customizable according to needs of the user. The user can come up with any kind of template add complex things such as mathematical proof or add code block/cells nearly anything one can think of. 
